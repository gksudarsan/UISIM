...
public class COMMON_CONSTANT {
	...
	public static final String CSR_USER_5 = "LnDFraudSpecialist"; //R&S Department with Research & Statistics Specialist Role
	public static final String CSR_USER_5_PASSWORD = "NewUser@123456";
	...
	public static final String CSR_USER_9 = "RegistrationSpecialist"; 
	public static final String CSR_USER_9_PASSWORD = "NewUser@123456";
	
	public static final String CSR_USER_10 = "RegistrationSupervisor"; 
	public static final String CSR_USER_10_PASSWORD = "NewUser@123456";
	...
	public static final String EMPLOYER_USER_4_PASSWORD = "NewUser@123444";
	...
	public static final String TPR_USER_2 = "TPRUser01"; //inactive
	public static final String TPR_USER_2_PASSWORD = "NewUser@123456";
	//TPR
	public static final String TPR_USER_3 = "tpruser02";//tpruser@123
	public static final String TPR_USER_3_PASSWORD = "NewUser@123456";//TprUser@123457
	
	public static final String TPR_USER_4 = "tpruser121";
	public static final String TPR_USER_4_PASSWORD = "Anoop@123456789";

	public static final String TPR_USER_5 = "psTPRUser";
	public static final String TPR_USER_5_PASSWORD = "NewUser@123456";
	

	public static final String TPR_USER_6 = "thirduseremp";
	public static final String TPR_USER_6_PASSWORD = "Thirduseremp@1234";
	
	public static final String TPR_USER_7 = "TPRUser01";
	public static final String TPR_USER_7_PASSWORD = "NewUser@123456";
	
	public static final String TPR_USER_8 = "psTPRUser";
	public static final String TPR_USER_8_PASSWORD = "NewUser@123456";
	
	public static final String TPR_USER = "psTPRUser";
    public static final String TPR_USER_PASSWORD = "NewUser@123456";
	...
	public static final String PEO_USER_2 = "PEOSpecialist";
	public static final String PEO_USER_2_PASSWORD = "NewUser@123456";
	...
	public static final String CLAIMENT_USER_PASSWORD1 = "Snehal@12345678";
	...
	// Appeals Account
	public static final String APPEALS_USER1 = "employeruserappeal";
	public static final String APPEALS_USER_PASSWORD1 = "EmployerUser@123456";
	...
	public static final String WRONG_PAGE_DISPALY = "Wrong page dispaly";
	public static final String MANUAL_FAILURE_AT_THIS_STEP = "Manual failure at this step.";
	...
	public static final String SECURE_MESSAGING_SPECIALIST_1 = "SecureMessagingSpecialistFirst";
	public static final String SECURE_MESSAGING_SPECIALIST_1_PASSWORD = "NewUser@123456";
	...
	public static final String LND_SPECIALIST_PASSWORD = "Test123456?@#%$";
	...
	public static final String CSR_Rating_Specialist = "RatingSpecialist";
	public static final String CSR_Rating_Specialist_PASSWORD = "NewUser@123456";
	
	public static final String CSR_General_Inquiry = "generalinquiry";
	public static final String CSR_General_Inquiry_PASSWORD = "NewUser@123456";
    ...
    //Collections Specialists 1 role
    public static final String CollectionsSpecialistUser_1 = "CollectionsSpecialistOne";
    public static final String CollectionsSpecialistUser_1_PASSWORD = "NewUser@123456";
    
    public static final String CollectionsSpecialistUser_3 = "CollectionsSpecialistThree";
    public static final String CollectionsSpecialistUser_3_PASSWORD = "NewUser@123456";
    
    //CSR with L&D Fraud Specialist role
    public static final String LDFraudSpecialist_UserName = "LnDFraudSpecialist";
    public static final String LDFraudSpecialist_PASSWORD = "NewUser@123456";
    
    //General Inquiry
    public static final String GeneralInquiry_UserName = "GeneralInquiry";
    public static final String GeneralInquiry_PASSWORD = "NewUser@123456";
    
    public static final String LDSpecialist_UserName = "LnDSpecialist";
    public static final String LDSpecialist_PASSWORD = "NewUser@123456";
    
    public static final String TRASPECIALIST = "traspecialist"; 
	public static final String TRASPECIALIST_PASSWORD = "NewUser@123456";

	public static final String DUA = "dua"; 
	public static final String DUA_PASSWORD = "NewUser@123456";
