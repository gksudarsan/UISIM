...
public class EmployerRegisterPage extends TestBase {
	...
	@FindBy(how = How.XPATH, using = "//textarea[contains(@aria-label,'Legal Name')]")
	...
	// --- SREG-004 ---
	// ---Contact Person for (Location of Books and Records) & (Notice of Potential
	// Charges (LO400)) Address ---
	...
	public void enterContactPersonFirstName(String xpathParameter, String value) {
		...
		driver.findElement(By.xpath("//mat-label[contains(.,'" + xpathParameter + "')]//following::input[1]"))
				.sendKeys(Keys.SPACE, Keys.BACK_SPACE);
		driver.findElement(By.xpath("//mat-label[contains(.,'" + xpathParameter + "')]//following::input[1]"))
				.sendKeys(value);
	}
	...
	public void enterContactPersonMiddleName(String xpathParameter, String value) {
		...
		driver.findElement(By.xpath("//mat-label[contains(.,'" + xpathParameter + "')]//following::input[2]"))
				.sendKeys(Keys.SPACE, Keys.BACK_SPACE);
		driver.findElement(By.xpath("//mat-label[contains(.,'" + xpathParameter + "')]//following::input[2]"))
				.sendKeys(value);
	}
	...
	@FindBy(how = How.XPATH, using = "//strong[text()='Agent (C/O) address']/../following-sibling::div/app-address/div/div[3]/div/div/mat-label[text()='Address Line 1 ']/following-sibling::mat-form-field/div/div/div/input")
	public WebElement agent_CO_AddresLine1;

	@FindBy(how = How.XPATH, using = "//strong[text()='Agent (C/O) address']/../following-sibling::div/app-address/div/div[4]/div/div/mat-label[text()='City ']/following-sibling::mat-form-field/div/div/div/input")
	public WebElement agent_CO_City;

	@FindBy(how = How.XPATH, using = "//strong[text()='Agent (C/O) address']/../following-sibling::div/app-address/div/div[4]/div/div/mat-label[text()='Zip Code']/following-sibling::mat-form-field/div/div/div/input")
...
//shubhanshi
	...
	@FindBy(how = How.XPATH, using = "//mat-label[text()='DOL Failed Reasons']/following-sibling::mat-label[text()='"
			+ ConstantData.EE_02_004_DOL_FAILED_REASON + "']")
	public WebElement dolFailedReasonText;

	@FindBy(how = How.XPATH, using = "//mat-label[text()='DOL Failed Reasons']/following-sibling::mat-label[text()='"
			+ ConstantData.EE_02_004_DTF_FAILED_REASON + "']")
	public WebElement dtfFailedReasonText;

	@FindBy(how = How.XPATH, using = "//input[@id='agadfirstNameId']")
	public WebElement agent_Co_First_Name;

	@FindBy(how = How.XPATH, using = "//input[@id='agadlastNameId']")
...
//--Workitem
	...
	@FindBy(how = How.XPATH, using = "//mat-label[text()='Principal Products Produced']/../following-sibling::div/mat-form-field/div/div/div/textarea")
	...
	@FindBy(how = How.XPATH, using = "//mat-label[text()='Principal Raw Materials Used']/../following-sibling::div/mat-form-field/div/div/div/textarea")
	...
	public WebElement agentCOAddress_CareOf;
