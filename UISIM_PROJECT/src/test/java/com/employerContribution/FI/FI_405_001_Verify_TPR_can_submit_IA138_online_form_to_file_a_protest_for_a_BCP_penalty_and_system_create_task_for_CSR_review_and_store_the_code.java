...
public class FI_405_001_Verify_TPR_can_submit_IA138_online_form_to_file_a_protest_for_a_BCP_penalty_and_system_create_task_for_CSR_review_and_store_the_code
		extends TestBase {

	@Test
	public void FI_405_001() throws Exception {

		test = report.createTest(
				"FI_405_001_Verify_TPR_can_submit_IA138_online_form_to_file_a_protest_for_a_BCP_penalty_and_system_create_task_for_CSR_review_and_store_the_code");
...
*/
		...
		commonFunction.ScrollMenu("I Accept");
		/*
		sleep(1000);
		commonFunction.ScrollMenu("Basis for disagreement");
		sleep(1000);
		commonFunction.ScrollMenu(" Other (Attach a separate sheet or documentation as necessary) ");
		sleep(1000);
		commonFunction.ScrollMenu("I Accept");
		sleep(1000);
		*/
		...
		sleep(2000);
		commonFunction.screenShot("Benefit Claim Penalty Assessment Protest (FIS-009)", "Pass", "Enter valid details on FIS_009 page");
		
		
		commonFunction.enterTextboxContains("Claimant Name", "Robert Fizz");
		sleep(1000);
		commonFunction.enterTextboxContains("SSN", "10098");
		sleep(1000);
		/*
		commonFunction.ScrollMenu("Basis for disagreement");
		sleep(1000);
		...
		commonFunction.screenShot("TC:  FI_405_001", "Pass", "test completed  ");
