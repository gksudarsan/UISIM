...
import java.util.Map;
	...
	public class FI_RPT_10_Generate_and_validate_the_report_EA6047_Listing_of_Employers_that_were_Selected_to_Receive_an_IA138_and_was_not_mailable extends TestBase {
		...
		public void FI_RPT_10() throws Exception {
			...
			cf.waitForLoadingIconToDisappear();
			cf.clickOnLinkfirstItem("LISTING OF EMPLOYERS THAT WERE SELECTED TO RECEIVE AN IA13.8 AND WAS UNMAILABLE");
			sleep(3000);
			cf.switchTab();
			cf.screenShot("Report", "Pass", "LISTING OF EMPLOYERS THAT WERE SELECTED TO RECEIVE AN IA13.8 AND WAS UNMAILABLE");
