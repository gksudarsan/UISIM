...
public class FI_445_004 extends TestBase {

	@Test(priority = 1, description = "FI.445.004. Verify CSR can view the BCP penalty details in order to determine if it is sustained when sustain code is 'Miscellaneous'", groups = {
			"Regression" })
	public void FI_445_004() throws Exception {
		...
		test = report.createTest(
				"FI.445.004. Verify CSR can view the BCP penalty details in order to determine if it is sustained when sustain code is 'Miscellaneous'");
