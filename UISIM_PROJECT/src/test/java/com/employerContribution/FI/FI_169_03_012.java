...
public class FI_169_03_012 extends TestBase {
	...
	@Test
	public void FI169_03_012() throws Exception {
		...
		commonFuntions.enterTextboxContains("Amount of the Interest Assessment Surcharge being Protested ($)", "2300");
		fis002.reasonBasisCommentfield.sendKeys("Test Reason Of Interest");
		...
		sleep(1000);
		commonFuntions.enterTextboxContains("Employer Registration Number", correctERN);
