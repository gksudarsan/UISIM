...
public class ERM_408_05_002 extends TestBase {

	@Test(priority=1, description = "ERM.408.05.002 - Verify system calculated rate when Employer process sale of business for own experience and indicate transfer 'Total' and validate Total Transfer Business Rules.",groups = {"Regression"})
	public void ERM_408_05_002() throws Exception
	{
		...
		test = report.createTest("ERM.408.05.002 - Verify system calculated rate when Employer process sale of business for own experience and indicate transfer 'Total' and validate Total Transfer Business Rules.");
