...
public class ERM_481_004 extends TestBase {
	...
	public void TC_ERM_481_004() throws Exception {
		...
		// --- SREG-060 --- //
		commonFunction.screenShot("Employer Rate Maintenance - Update Contribution Rate", "Pass",
				"Successfully launched on SREG-060");
		...
		// --- SREG-061 --- //
		commonFunction.screenShot("Employer Rate Maintenance Verification", "Pass",
				"Successfully launched to SREG-061");
		commonFunction.selectRadioQuestions("Generate Rate Statement", "No ");
		homePage.submitButton.click();
		sleep(2000);

		// --- SUC-002 --- //
		commonFunction.screenShot("Employer Rate Maintenance Confirmation", "Pass",
				"The Employer Rate Information has been successfully modified and saved - Successfully launched to SUC-002");
		...
		// commonFunction.selectTableParameterizedId("4.8", 1, 8, "Rate History",
		// "employerRateHistory");
		...
		commonFunction.selectTableWithoutId("Administrative Decision", 2, 2,
		...
		// --- SREG-063 --- //
		commonFunction.screenShot("Ledger after Transaction", "Pass", "Successfully launched to SREG-063");
		commonFunction.clickButton("Previous ");

		// Previous to SREG-052
		commonFunction.clickButton(" Previous ");
		commonFunction.screenShot("Back to Inquiry Employer Account Information Page", "Pass",
				"Successfully launched to SREG-051");
		sleep(2000);
		commonFunction.selectTableWithoutId("Year", 1, 1, "Rate History");
