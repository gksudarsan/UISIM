...
public class ERM_408_10_001_Verify_system_calculated_rate_when_CSR_process_void_transfer_with_reason_of_voiding_transfer_for_employer extends TestBase {
	@Test
	public void ERM_408_10_001() throws Exception
	{
test = report.createTest("ERM_408_10_001_Verify system calculated rate when CSR process void transfer with reason of voiding transfer is \"Effective Date Change\"");
		...
		sleep(2000);
		commonFunction.selectDropdown("Reason For Voiding Transfer", " No Transfer Occurred ");
		sleep(2000);
