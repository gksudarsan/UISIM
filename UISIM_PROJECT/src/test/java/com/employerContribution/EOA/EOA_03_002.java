...
public class EOA_03_002 extends TestBase {

	@Test(priority = 1, description = "EOA.03.002-Verify Employer Master Administrator can access Employer account and add, edit user(s) (Add User Type - Employer Sub-User and User Role - Benefits)", groups = {
			"Regression" })
	public void EOA_03_002() throws Exception {
		commonStepDefinitions commonFuntions = new commonStepDefinitions();
		FIpage FI = new FIpage(driver);

		test = report.createTest(
				"EOA.03.002-Verify Employer Master Administrator can access Employer account and add, edit user(s) (Add User Type - Employer Sub-User and User Role - Benefits)");

		LoginPage loginPage = PageFactory.initElements(driver, LoginPage.class);
		commonFuntions.login(COMMON_CONSTANT.EMPLOYER_USER_4, COMMON_CONSTANT.EMPLOYER_USER_4_PASSWORD);
		...
		commonFuntions.enterTextboxContains("First Name", "Priyanshi");
		commonFuntions.enterTextboxContains("Last Name", "bhatacharrya");
		commonFuntions.enterTextboxContains("Email Address", "priyanshi@labor.ny.gov");
