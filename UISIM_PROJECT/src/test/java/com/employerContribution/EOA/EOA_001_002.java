...
public class EOA_001_002 extends TestBase {
    ...
    public void EOA_01_002() throws Exception {
        ...
        test.info("Step: 2 -- ");
        commonFuntions.selectRadioQuestions("Select at least one of the following options", "I am a Third Party Representative who needs to create an online account to represent my clients in Unemployment Insurance matters.");
        sleep(2000);
