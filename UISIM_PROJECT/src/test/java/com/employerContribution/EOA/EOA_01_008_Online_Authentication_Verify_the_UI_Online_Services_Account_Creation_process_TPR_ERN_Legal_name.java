...
public class EOA_01_008_Online_Authentication_Verify_the_UI_Online_Services_Account_Creation_process_TPR_ERN_Legal_name
		extends TestBase {

	@Test(priority = COMMON_CONSTANT.PRIORITY_1, description = "Online Authentication - Verify the UI Online Services Account Creation process (TPR) - (ERN, Legal name)", groups = {
			COMMON_CONSTANT.REGRESSION })

	public void EOA_01_008() throws Exception {
		
		test = report.createTest(
				"EOA_01_008_Online_Authentication_Verify_the_UI_Online_Services_Account_Creation_process_TPR_ERN_Legal_name");
		...
		//----EOA - 002
				...
				//----SUC-002
					...
					commonFuntions.screenShot("TC:  EOA_01_008", "Pass", "test completed  ");
					// completed by Palak
	}
