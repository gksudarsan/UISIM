...
public class SM_002_005_SuggestionTypeFraud extends TestBase {

	@Test
	public void SM_002_005() throws Exception {
		commonStepDefinitions cf = new commonStepDefinitions();
		AddressPage AddPage = PageFactory.initElements(driver, AddressPage.class);
		test = report.createTest(
				"SM.002.005-Verify that the system displays a suggestion, but the Employer will not be able to write and send a message. (Suggestion Type H)");
