...
public class EL_02_011_CSR_Can_Register_Limited_liable_partnership extends TestBase {
	...
	@Test(priority = 1, description = "EL.02.011 : Verify CSR can register  PEO Exempt for Type of Legal Entity ' Limited Liability Partnership'", groups = {
			"Regression" })
	public void EL_02_011() throws Exception {
		test = report.createTest(
				"EL.02.011 : Verify CSR can register  PEO Exempt for Type of Legal Entity ' Limited Liability Partnership'");
