...
public class EL_322_002_PEOAdmin_Can_Register_IndividualPeo_SoleProprietorship extends TestBase
{


	
	@Test(priority=1, description = "EL.322.002: Verify PEO Admin can register Individual PEO for Type of Legal Entity 'Sole Proprietorship' and  type of Ownership 'Privately or Closely Held'",groups = {"Regression"})
	public void EL_322_002() throws Exception
	{
		...
		System.out.println("feinValue is"+feinValue);
		 test = report.createTest("EL.322.002: Verify PEO Admin can register Individual PEO for Type of Legal Entity 'Sole Proprietorship' and  type of Ownership 'Privately or Closely Held'");
