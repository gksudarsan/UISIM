...
public class EL_03_06 extends TestBase{
	...
	public void EL_03_06() throws Exception
	{
		...
		Thread.sleep(2000);
		Map<String, String> databaseResults = commonFuntions.database_SelectQuerySingleColumn("SELECT * FROM T_TX_PEO_ACCOUNT ttpa WHERE TYPE_OF_REQUEST='PEOER'", "PEO_NAME");
