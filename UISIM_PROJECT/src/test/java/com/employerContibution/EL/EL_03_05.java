...
public class EL_03_05 extends TestBase{

	@Test(priority=1, description = "EL.03.05 - Verify CSR can update PEO Status 'Suspended' for PEO Exempt Information",groups = {"Regression"})
	public void EL_03_05() throws Exception
	{
		commonStepDefinitions commonFuntions= new commonStepDefinitions();
		PEOPage PEOPage = PageFactory.initElements(driver, PEOPage.class);
		test = report.createTest("EL.03.06 - Verify CSR can update PEO Status 'Suspended' for PEO Exempt Information");
		...
		Assert.assertEquals(PEOPage.withdrawnMessage.getText(), "Suspended");
