...
public class EL_322_009 extends TestBase
{


	
	@Test(priority=1, description = "EL.322.009: Verify CSR can register Individual PEO for Type of Legal Entity 'Partnership' and  type of Ownership 'Privately or Closely Held'.",groups = {"Regression"})
	public void EL_322_009() throws Exception
	{
		...
		Map<String, String> databaseResults = PEOPage.database_SelectQuery("SELECT FEIN,EAN FROM T_EMPLOYER_ACCOUNT tea WHERE EAN IS NOT NULL AND FEIN IS NOT NULL");
		String feinValue =databaseResults.get("Fein");
		String ernValue = databaseResults.get("Ean");
		System.out.println("feinValue is"+feinValue);
		 test = report.createTest("EL.322.009: Verify CSR can register Individual PEO for Type of Legal Entity 'Partnership' and  type of Ownership 'Privately or Closely Held'.");
