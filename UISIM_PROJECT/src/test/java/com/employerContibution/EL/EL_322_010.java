...
public class EL_322_010 extends TestBase
{
	...
	public void EL_322_010() throws Exception
	{
		 ...
		 String feinValue=StringUtils.left( String.valueOf((long) (Math.random()*Math.pow(10,10))),9); commonFuntions.enterTextboxContains("Employer Registration Number",ernValue);
