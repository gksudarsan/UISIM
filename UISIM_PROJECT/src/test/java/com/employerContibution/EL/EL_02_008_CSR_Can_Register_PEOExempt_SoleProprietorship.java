...
public class EL_02_008_CSR_Can_Register_PEOExempt_SoleProprietorship extends TestBase{

	@Test(priority=1, description = "EL.02.008 : Verify CSR can register  PEO Exempt for Type of Legal Entity ' Sole Proprietorship'",groups = {"Regression"})
	public void EL_02_008() throws Exception{
		 test = report.createTest("EL.02.008 : Verify CSR can register  PEO Exempt for Type of Legal Entity '  Sole Proprietorship'");
	     ...
	     commonFuntions.selectDropdownEquals("Type of Legal Entity", " Sole Proprietorship (Individual) ");
