...
public class EL_02_010_CSR_Can_Register_Company extends TestBase {
	...
	@Test(priority = 1, description = "EL.02.010 : Verify CSR can register  PEO Exempt for Type of Legal Entity ' Limited Liability Company' .", groups = {
			"Regression" })
	public void EL_02_012() throws Exception {
		test = report.createTest(
				"EL.02.010 : Verify CSR can register  PEO Exempt for Type of Legal Entity ' Limited Liability Company' .");
