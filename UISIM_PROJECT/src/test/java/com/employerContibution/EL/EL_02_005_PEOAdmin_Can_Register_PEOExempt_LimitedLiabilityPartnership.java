...
public class EL_02_005_PEOAdmin_Can_Register_PEOExempt_LimitedLiabilityPartnership extends TestBase{

	@Test(priority=1, description = "EL.02.005 : Verify PEO Admin can register  PEO Exempt for Type of Legal Entity ' Limited Liability Partnership' .",groups = {"Regression"})
	public void EL_02_005() throws Exception{
		 test = report.createTest("EL.02.005 : Verify PEO Admin can register  PEO Exempt for Type of Legal Entity ' Limited Liability Partnership' .");
