...
public class EL_02_004_PEOAdmin_Can_Register_PEOExempt_LimitedLiabilityCompany extends TestBase{

	@Test(priority=1, description = "EL.02.004 : Verify PEO Admin can register  PEO Exempt for Type of Legal Entity ' Limited Liability Company' .",groups = {"Regression"})
	public void EL_02_003() throws Exception{
		 test = report.createTest("EL.02.004 : Verify PEO Admin can register  PEO Exempt for Type of Legal Entity ' Limited Liability Company' .");
...
commonFuntions.screenShot("Completion","Pass","Register/Renew Confirmation");
	     ...
	     sleep(2000);
	     commonFuntions.logoutAndLogin("ndfjp3", "Admin@12345678");
	    PEOPage.queue.click();
	    sleep(15000);
