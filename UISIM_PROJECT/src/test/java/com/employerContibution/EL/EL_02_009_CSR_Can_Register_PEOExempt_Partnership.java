...
public class EL_02_009_CSR_Can_Register_PEOExempt_Partnership extends TestBase{

	@Test(priority=1, description = "EL.02.009 : Verify CSR can register  PEO Exempt for Type of Legal Entity ' Partnership'",groups = {"Regression"})
	public void EL_02_009() throws Exception{
		 test = report.createTest("EL.02.009 : Verify CSR can register  PEO Exempt for Type of Legal Entity '  Partnership'");
