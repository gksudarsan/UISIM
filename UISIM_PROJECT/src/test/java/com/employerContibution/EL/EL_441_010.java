...
public class EL_441_010 extends TestBase {

	@Test(priority = 1, description = "EL.441.010 - Verify CSR can register PEO Group  for Type of Legal Entity 'Limited Liability Company' and Type of Ownership 'Privately or Closely Held'.", groups = {
			"Regression" })
	public void EL_441_010() throws Exception {
		test = report.createTest(
				"EL.441.010 - Verify CSR can register PEO Group  for Type of Legal Entity 'Limited Liability Company' and Type of Ownership 'Privately or Closely Held'.");
		...
		Thread.sleep(2000);
		commonFuntions.screenShot("Verify Current Additional Address", "PASS",
		...
		commonFuntions.clickButtonContains("Save & Continue");
		Thread.sleep(2000);
		commonFuntions.screenShot("Verify Prior Address(es) in New York", "PASS",
		...
		commonFuntions.enterTextboxContains("Address Line 1",
				"PowneraddressLine1" + commonFuntions.createRandomInteger(1000, 9999));
		commonFuntions.enterTextboxContains("Address Line 2",
				"PowneraddressLine2" + commonFuntions.createRandomInteger(1000, 9999));
		commonFuntions.enterTextboxContains("City", "NewYork");
		commonFuntions.enterTextboxContains("Zip Code", "13430");
		...
		// blocked the test case at step26 as not able to search with fein number for
		// peo member
