...
public class EL_322_004_PEOAdmin_Can_Register_IndividualPeo_LimitedLiabilityCompany extends TestBase
{
	    ...
	    commonFuntions.clickButtonContains("Continue");
	     ...
	     try {
		   ...
		   //  commonFuntions.enterTextboxContains("Enter name of Officer, Partner, Proprietor or Member","TestAutomation"+commonFuntions.createRandomInteger(10000,99999));
		     ...
		     commonFuntions.selectRadio("Pending");
		     commonFuntions.screenShot("PendingPage","Pass","ApprovalPage");
