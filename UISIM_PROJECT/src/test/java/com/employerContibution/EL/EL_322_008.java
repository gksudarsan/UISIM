...
public class EL_322_008 extends TestBase
{


	
	@Test(priority=1, description = "EL.322.008: Verify CSR can register Individual PEO for Type of Legal Entity 'Sole Proprietorship' and  type of Ownership 'Privately or Closely Held'",groups = {"Regression"})
	public void EL_322_008() throws Exception
	{
		...
		System.out.println("feinValue is"+feinValue);
		 test = report.createTest("EL.322.008: Verify CSR can register Individual PEO for Type of Legal Entity 'Sole Proprietorship' and  type of Ownership 'Privately or Closely Held'");
