...
public class EL_322_003_PEOAdmin_Can_Register_IndividualPeo_Partnership extends TestBase
{


	
	@Test(priority=1, description = "EL.322.003: Verify PEO Admin can register Individual PEO for Type of Legal Entity 'Partnership' and  type of Ownership 'Privately or Closely Held'.",groups = {"Regression"})
	public void EL_322_003() throws Exception
	{
		...
		System.out.println("feinValue is"+feinValue);
		 test = report.createTest("EL.322.003: Verify PEO Admin can register Individual PEO for Type of Legal Entity 'Partnership' and  type of Ownership 'Privately or Closely Held'.");
