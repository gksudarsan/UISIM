...
public class EL_322_014 extends TestBase {
	...
	@Test(priority = 1, description = "EL.322.012: Verify CSR can register Individual PEO for Type of Legal Entity 'Other' and  type of Ownership 'Privately or Closely Held'.", groups = {
			"Regression" })
