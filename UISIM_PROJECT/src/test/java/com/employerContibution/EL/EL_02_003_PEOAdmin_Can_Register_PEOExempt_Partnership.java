...
public class EL_02_003_PEOAdmin_Can_Register_PEOExempt_Partnership extends TestBase{
...
commonFuntions.screenShot("Completion","Pass","Register/Renew Confirmation");
	     ...
	     commonFuntions.database_UpdateQuery("UPDATE LROUIM.T_WFA_WORK_ITEM_DETAIL SET USER_ID = SET USER_ID = ''"+COMMON_CONSTANT.CSR_USER_1+"'' WHERE PROCESS_DETAIL_ID IN (SELECT PROCESS_DETAIL_ID FROM T_WFA_PROCESS_DETAIL WHERE FEIN='"+feinValue+"' ORDER BY UPDATED_TS desc)");
	     sleep(2000);
