...
public class CA_067_03_012 extends TestBase {
	@Test
	public void CA_067_03_012() throws Exception
	{
		
		 test = report.createTest("CA.067.03.012 -- Verify CSR can add Deposit Details of processing vendors  for deposit type 'Paper IA' and update interface status 'Overridden'");
		 ...
		 //Map<String, String> databaseResults = commonFuntions.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER te WHERE EAN = '0463015' ORDER BY UPDATED_TS","EAN");
			...
			commonFuntions.waitForLoadingIconToDisappear();
			 ...
			 commonFuntions.selectActionTableParameterizedId("PAPER IA",1,1,"Deposit Details for Processing Vendor","id02","textBox","100");
			 commonFuntions.screenShot("ValuesEntered","Pass","Values Entered");
			 commonFuntions.selectActionTableParameterizedId("PAPER IA",8,1,"Deposit Details for Processing Vendor","id02","listBox","overideComments");
			 commonFuntions.screenShot("updated","Pass","override Comments Updated");
			 commonFuntions.selectActionTableParameterizedId("PAPER IA",7,1,"Deposit Details for Processing Vendor","id02","link","2");
