...
public class Oth_Src_6_Source_IA602andSourceType_LO447SpecialLiabilityInvestigation extends TestBase{

	@Test
	public void Oth_Src_6() throws Exception {
		commonStepDefinitions cf = new commonStepDefinitions();
		AddressPage AddPage = PageFactory.initElements(driver, AddressPage.class);
		test = report.createTest("Oth_Src_6:Verify that account can be created from source 'IA602' and Source Type 'LO447 Special Liability Investigation'");
...
//		String feinValue = databaseResults.get("FEIN");
		...
		cf.selectDropdown("Source Type", " LO447 – Special Liability Investigation ");sleep();
