...
import com.aventstack.extentreports.Status;
	...
	public class EE_03_003_Verify_CSR_can_submit_employer_registration_for_employer_type_Governmental_and_legal_entity_type_Village_and_work_items_will_be_created_for_CSR_to_review extends TestBase{

		@Test()
			public void EE_03_003_Verify_CSR_can_submit_employer_registration_for_employer_type_Governmental_and_legal_entity_type_Village_and_work_items_will_be_created_for_CSR_to_review () throws Exception {
			...
			commonFunction.selectDropdown("Source Type", "NYS-100G");sleep(2000);
			commonFunction.screenShot("Menu", "Pass", "Employer Registration");
			commonFunction.clickButtonContains("Continue");sleep(2000);
		...
		/*
		 * commonFunction.enterTextboxContains("Address Line 1","7th Street 40 E 7th St"
		 * );sleep(2000); commonFunction.enterTextboxContains("Address Line 2","");
		 ...
		 * "Add executor page is displayed");
		 * commonFunction.enterTextboxContains("First Name", "Test");
		 * commonFunction.enterTextboxContains("Last Name", "AutoTest");
		 * commonFunction.enterTextboxContains("Address Line 1", "Ave"+
		 * commonFunction.createRandomInteger(10,99));
...
//			commonFunction.selectDropdown("*Account Status ", "Liable");
			...
			//commonFunction.selectDropdown("*Account Status ", "Liable");
			//commonFunction.enterTextboxContains("Comment", "registration in process");
			//ommonFunction.clickButtonContains("Submit"); Thread.sleep(2000);
			commonFunction.screenShot("GeneralInfo","Pass","General Information");
