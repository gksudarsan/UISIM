...
public class Oth_Src_5_Source_IA602andSourceType_LiabilityInvestigation extends TestBase{

	@Test
	public void Oth_Src_5() throws Exception {
		commonStepDefinitions cf = new commonStepDefinitions();
		AddressPage AddPage = PageFactory.initElements(driver, AddressPage.class);
		test = report.createTest("Oth_Src_5:Verify that account can be created from source 'IA602' and Source Type 'Liability Investigation'");
...
//		String feinValue = databaseResults.get("FEIN");
		...
		cf.selectDropdown("Source Type", " Liability Investigation ");sleep();
...
//		String legalName = databaseResults_LegalName.get("ENTITY_NAME");
		...
		cf.enterTextboxContains("Total number of covered employees", "36");
