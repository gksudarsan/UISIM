...
public class Oth_Src_4_Source_IA602andSourceType_Fraud extends TestBase{

	@Test
	public void Oth_Src_4() throws Exception {
		commonStepDefinitions cf = new commonStepDefinitions();
		AddressPage AddPage = PageFactory.initElements(driver, AddressPage.class);
		test = report.createTest("Oth_Src_4:Verify that account can be created from source 'IA602' and Source Type 'Fraud'");
...
//		String feinValue = databaseResults.get("FEIN");
		...
		cf.selectDropdown("Source Type", " Fraud ");sleep();
...
//		String legalName = databaseResults_LegalName.get("ENTITY_NAME");
		...
		cf.selectDropdown("Year ", " 2021 ");sleep();
