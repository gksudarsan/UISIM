...
public class Oth_Src_7_Source_IA602andSourceType_PEOTermination extends TestBase{

	@Test
	public void Oth_Src_7() throws Exception {
		commonStepDefinitions cf = new commonStepDefinitions();
		AddressPage AddPage = PageFactory.initElements(driver, AddressPage.class);
		test = report.createTest("Oth_Src_7:Verify that account can be created from source 'IA602' and Source Type 'PEO Termination'");
...
//		String feinValue = databaseResults.get("FEIN");
		...
		cf.selectDropdown("Source Type", " PEO Termination ");sleep();
...
//		String legalName = databaseResults_LegalName.get("ENTITY_NAME");
		...
		cf.enterTextboxContains("Total number of covered employees", "32");
