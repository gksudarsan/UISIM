...
public class EE_13_002 extends TestBase {

	@Test()
	public void EE_13_002() throws Exception {
		...
		cf.selectDropdown("Employer Type", " Agriculture ");
		...
		sleep(3000);
		cf.selectDropdown("Source", " IA602 ");
		cf.selectDropdown("Source Type", " Partnership ");
		cf.clickButton("Continue ");
		sleep(3000);
