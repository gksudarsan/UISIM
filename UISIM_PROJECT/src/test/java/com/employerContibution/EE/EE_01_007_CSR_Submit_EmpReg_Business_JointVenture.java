...
//		commonFunction.enterTextboxContains("Federal Employer Identification Number (FEIN)", "302298634"); //202298634
//		commonFunction.selectDropdownEquals("Type of Legal Entity", " Joint Venture - Internal User only ");
//		sleep();
//		commonFunction.enterTextboxContains("Employer Registration Number", "3070072"); //2070072
...
//		empRegPage.legalNameTextBox.sendKeys("BRIZZY CONTRACTING INC"); //WINEBOOKINGS.COM LLC        
