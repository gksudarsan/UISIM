...
public class EE_09_002_Verify_employer_can_submit_employer_registration_for_employer_type_Indian_Tribe_and_legal_entity_type_Business_and_work_items_will_be_created_for_CSR_to_review
		extends TestBase {

	@Test()
	public void EE_09_002_Verify_employer_type_Indian_Tribe()
			throws Exception {
		...
		test = report.createTest(
				"EE_09_002_Verify_employer_can_submit_employer_registration_for_employer_type_Indian_Tribe_and_legal_entity_type_Business_and_work_items_will_be_created_for_CSR_to_review");
		...
		sleep(3000);
		commonFunction.clickMenu("Menu");sleep(10000);
		...
		commonFunction.screenShot("Menu", "Pass", "Employer Registration");
		commonFunction.populateListbox("Legal Name", "RD 937");
		sleep(2000);
		...
		sleep(2000);
		commonFunction.enterTextboxContains("Zip Code", "10010");
		sleep(2000);
		...
		commonFunction.database_UpdateQuery("UPDATE LROUIM.T_WFA_WORK_ITEM_DETAIL SET USER_ID = '"
				...
				+ "' WHERE PROCESS_DETAIL_ID IN (SELECT PROCESS_DETAIL_ID FROM T_WFA_PROCESS_DETAIL WHERE FEIN='99-9971203' ORDER BY UPDATED_TS desc)");
		Thread.sleep(2000);
		PEOPage.queue.click();
		Thread.sleep(15000);
		...
		commonFunction.screenShot("FeinSearch", "Pass", "feinSearch");
		// commonFunction.clickButtonContains("Search"); Thread.sleep(2000);
		commonFunction.screenShot("Unable to Determine Liability Task", "Pass",
				"Unable to Determine Liability Taskis displayed");
		Thread.sleep(2000);
		commonFunction.clickButtonContains("Open Work Item");
		Thread.sleep(2000);
		commonFunction.screenShot("EEWI-002", "Pass", "review emp type  ");
