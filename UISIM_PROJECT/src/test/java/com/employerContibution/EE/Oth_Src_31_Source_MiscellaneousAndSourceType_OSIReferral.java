...
public class Oth_Src_31_Source_MiscellaneousAndSourceType_OSIReferral extends TestBase{

	@Test
	public void Oth_Src_31() throws Exception {
		commonStepDefinitions cf = new commonStepDefinitions();
		AddressPage AddPage = PageFactory.initElements(driver, AddressPage.class);
		test = report.createTest("Oth_Src_31:Verify that account can be created from source 'Miscellaneous' and Source Type 'OSI Referral (Office of Special Investigations)'");
		...
		cf.selectDropdown("Source Type", " OSI Referral (Office of Special Investigations) ");sleep();
        ...
        AddPage.legalNameTextBox.sendKeys("MOTORS AUTO LLC");
