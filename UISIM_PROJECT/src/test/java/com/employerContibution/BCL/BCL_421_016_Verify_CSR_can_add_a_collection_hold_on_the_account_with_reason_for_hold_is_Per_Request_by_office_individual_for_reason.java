...
public class BCL_421_016_Verify_CSR_can_add_a_collection_hold_on_the_account_with_reason_for_hold_is_Per_Request_by_office_individual_for_reason
		extends TestBase {

	@Test(priority = 1, description = "BCL.421.016 - Verify_CSR_can_add_a_collection_hold_on_the_account_with_reason_for_hold_is_Per_Request_by_office_individual_for_reason", groups = {
			"Regression" })
	public void BCL_421_016() throws Exception {
		...
		test = report.createTest(
				"BCL_421_016 - Verify CSR can add a collection hold on the account with reason for hold is Hearing Pending");
		// -----Login
	...
	/*
		...
		sleep(2000);
		commonFuntions.selectDropdown("Reason For Hold", " Per Request by (office/individual) for (reason) ");
		sleep(2000);
		...
		// --- Home ---
		commonFuntions.waitForLoadingIconToDisappear();
		commonFuntions.screenShot("BCL_421_016", "Pass", "Successfully passed TC BCL_421_016");
	}
