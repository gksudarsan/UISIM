...
public class BCL_802_05_014 extends TestBase {

	@Test(priority = 1, description = "BCL.802.05.014 -  Verify CSR can Search ERN with select bankruptcy appropriate case status and add Bankruptcy Case Activity for activity type Outgoing and activity name 'Plan Confirmed Letter'", groups = {
			"Regression" })
	public void BCL_802_05_014() throws Exception {
		...
		test = report.createTest(
				"BCL.802.05.014 -  Verify CSR can Search ERN with select bankruptcy appropriate case status and add Bankruptcy Case Activity for activity type Outgoing and activity name 'Plan Confirmed Letter'");
		...
		commonFuntions.selectRadioQuestions("2. Is a response expected ?", "No ");
		commonFuntions.selectDropdown("3. Activity Name", " Plan Confirmed Letter ");
		commonFuntions.clearTextboxContains("4. Remarks");
		commonFuntions.enterTextboxContains("4. Remarks", "Pla the confirmed letter");
		commonFuntions.enterTextboxContains("5. Activity Date", "6/23/2023");
