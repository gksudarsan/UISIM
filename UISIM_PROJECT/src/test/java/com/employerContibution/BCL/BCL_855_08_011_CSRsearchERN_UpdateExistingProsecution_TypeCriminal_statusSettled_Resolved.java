...
public class BCL_855_08_011_CSRsearchERN_UpdateExistingProsecution_TypeCriminal_statusSettled_Resolved extends TestBase {

	@Test(priority = COMMON_CONSTANT.PRIORITY_1, description = "Verify CSR can search ERN details and update existing prosecution for Prosecution Type is 'Criminal' and status is 'Settled/Resolved'", groups = "Regression")
	public void BCL_855_08_011() throws Exception {

		test = report.createTest("BCL_855_08_011_Verify CSR can search ERN details and update existing prosecution for Prosecution Type is 'Criminal' and status is 'Settled/Resolved'");
		...
		commonFuntions.selectDropdown("7. Status", "Settled/Resolved");
		bcllocators.Entercomments_COL596.clear();
		bcllocators.Entercomments_COL596.sendKeys("Prosecution status has been Resolved, so act accordingly");
		sleep(1000);
