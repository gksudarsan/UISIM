...
public class BCL_421_002_CSRaddcollectionhold_reasonHoldActiononAccount extends TestBase {

	@Test(priority = COMMON_CONSTANT.PRIORITY_1, description = "Verify CSR can add a collection hold on the account with reason for hold is Hold Action on Account", groups = "Regression")
	public void BCL_421_002() throws Exception {

		test = report.createTest("BCL_421_002_Verify CSR can add a collection hold on the account with reason for hold is Hold Action on Account");
		...
		commonFuntions.selectDropdown("Reason For Hold", " Hold Action on Account ");
		bcllocators.otherreason_MaintainCollectionHold.sendKeys("Hold Action applied on Account");
