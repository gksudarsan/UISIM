...
public class BCL_802_003_Verify_CSR_can_search_ERN_details_with_bankruptcy_chapter_13 extends TestBase {
	@Test
	public void BCL_802_003() throws Exception {
		...
		sleep();
		cf.selectDropdown("5. Bankruptcy Chapter", "Chapter 13");
		...
		sleep(3000);
		cf.selectDropdown("9. Bankruptcy District", " Northern ");
		...
		cf.clickOnLinkAnchorTag("https://www.nynb.uscourts.gov");
		sleep();
		cf.screenShot("United States Bankruptcy Court Doc", "Pass", "Launched to Northern Doc");
