...
public class BCL_421_006 extends TestBase {

	@Test(priority = 1, description = "BCL.421.006 -   Verify CSR can add a collection hold on the account with reason for hold is Promise to Pay", groups = {
			"Regression" })
	public void BCL_421_006() throws Exception {
		...
		test = report.createTest(
				"BCL.421.006 -   Verify CSR can add a collection hold on the account with reason for hold is Promise to Pay");
		...
		commonFuntions.selectDropdown("Reason For Hold", " Promise to Pay ");
		sleep(1000);
