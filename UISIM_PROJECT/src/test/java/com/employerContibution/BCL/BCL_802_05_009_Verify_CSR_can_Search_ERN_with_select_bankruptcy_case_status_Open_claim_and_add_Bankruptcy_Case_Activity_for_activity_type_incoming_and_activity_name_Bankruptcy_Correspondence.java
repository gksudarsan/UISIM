...
public class BCL_802_05_009_Verify_CSR_can_Search_ERN_with_select_bankruptcy_case_status_Open_claim_and_add_Bankruptcy_Case_Activity_for_activity_type_incoming_and_activity_name_Bankruptcy_Correspondence
		extends TestBase {
	@Test
	public void BCL_802_05_009() throws Exception {

		test = report.createTest(
				"BCL_802_05_009 - Verify CSR can search for warrants in active status based on ERN and Satisfy warrant details");
		...
		// --- Home ---
		commonFuntions.waitForLoadingIconToDisappear();
		commonFuntions.screenShot("BCL_802_05_009", "Pass", "Successfully passed TC BCL_802_05_009");
