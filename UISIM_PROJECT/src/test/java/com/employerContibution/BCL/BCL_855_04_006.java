...
public class BCL_855_04_006 extends TestBase {
	@Test
	public void BCL_855_04_006() throws Exception
	{
		
		 test = report.createTest("BCL.855.04.006 -  Verify CSR can search ERN and put ALL NPRs for an SSN on hold with status is 'Hold' and reason is 'Pending Income Execution''");
		 ...
		 sleep(1000);
			...
			sleep();
			BclPage.updateReferralReasonPendingIncomeValue.click();
			sleep();
