...
public class BCL_485_001_Verify_CSR_can_search_for_warrants_in_active_status_based_on_ERN_and_destroyed_warrant_details
	...
	public void BCL_485_001() throws Exception {
		...
		Map<String, String> databaseResults = commonFuntions.database_SelectQuerySingleColumn("SELECT\r\n" + 
				...
				"							(CASE WHEN TW.WARRANT_STATUS_CD = 'ACTV' THEN 'Active' END ) AS WARRANT_STATUS,\r\n" + 
				...
				"							TW.COUNTY = TMC.\"KEY\"\r\n" + 
				"						LEFT JOIN T_TX_WARRANT_ENROLLMENT TWE ON\r\n" + 
				...
				"							(CASE WHEN TWT.TRANSCRIPT_STATUS = 'ACTV' THEN 'Active' END ) AS WARRANT_STATUS,\r\n" + 
