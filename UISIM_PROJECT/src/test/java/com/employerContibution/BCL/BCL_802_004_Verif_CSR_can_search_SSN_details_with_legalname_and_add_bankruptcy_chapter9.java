...
public class BCL_802_004_Verif_CSR_can_search_SSN_details_with_legalname_and_add_bankruptcy_chapter9 extends TestBase {
	@Test
	public void BCL_802_004() throws Exception {
		test = report.createTest(
				"BCL.802.004 - Verify CSR  can search SSN details with legal name and add bankruptcy details for the Employer/responsible party with bankruptcy chapter 9");
		...
		sleep();
		cf.selectDropdown("5. Bankruptcy Chapter", "Chapter 9");
		...
		sleep(3000);
		cf.selectDropdown("9. Bankruptcy District", " Southern ");
		...
		cf.clickOnLinkAnchorTag("https://www.nysb.uscourts.gov");
		sleep();
		cf.screenShot("United States Bankruptcy Court Doc", "Pass", "Launched to Southern Doc");
