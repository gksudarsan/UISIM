...
public class BCL_802_05_013_Verify_CSR_can_Search_ERN_with_select_bankruptcy_case_status_New_Proceedings_and_add_Bankruptcy_Case_Activity_for_activity_type_outgoing_and_activity_name_Bankruptcy_Correspondence
		extends TestBase {
	@Test
	public void BCL_802_05_013() throws Exception {

		test = report.createTest(
				"BCL_802_05_013 - Verify CSR can search for warrants in active status based on ERN and Satisfy warrant details");
		...
		commonFuntions.selectDropdown("3. Activity Name", " Bankruptcy Correspondence ");
		...
		// --- Home ---
		commonFuntions.waitForLoadingIconToDisappear();
		commonFuntions.screenShot("BCL_802_05_013", "Pass", "Successfully passed TC BCL_802_05_013");
