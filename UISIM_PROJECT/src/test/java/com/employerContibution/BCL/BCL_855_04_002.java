...
public class BCL_855_04_002 extends TestBase {
	...
	public void BCL_855_04_002() throws Exception
	{
		 ...
		 test = report.createTest("BCL.855.04.002 - Verify CSR can search for the list of mailed NPR letters for an ERN");
		...
		// ----COL-586
			commonFuntions.waitForLoadingIconToDisappear();
			commonFuntions.screenShot("Update NPR Referral to Treasury – Enter ERN/SSN/FEIN", "Pass", "Successfully launched to COL-586 page");
			sleep(2000);
			...
			commonFuntions.screenShot("Update NPR Referral to Treasury","Pass","Selected NPR Referral to Treasury  COL-586 page");					
			commonFuntions.clickButtonContains("Continue");
			commonFuntions.waitForLoadingIconToDisappear();
			//------COL-587
			commonFuntions.screenShot("NoticeOfPendingReferralList","Pass","Selected Notice of pending referralList  COL-587 page");					
