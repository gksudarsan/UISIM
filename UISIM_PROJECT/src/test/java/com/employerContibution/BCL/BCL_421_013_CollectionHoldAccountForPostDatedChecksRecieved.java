...
public class BCL_421_013_CollectionHoldAccountForPostDatedChecksRecieved extends TestBase {

	@Test
	public void BCL_421_013() throws Exception {
		...
		test = report.createTest(
				"BCL.421.013-Verify CSR can add a collection hold on the account with reason for hold is Post-Dated Checks Received");
		...
		cf.selectDropdown("Reason For Hold", " Post-Dated Checks Received ");
