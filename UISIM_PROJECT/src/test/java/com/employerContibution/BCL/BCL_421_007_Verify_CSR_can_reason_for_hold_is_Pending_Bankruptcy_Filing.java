...
import java.util.Map;
	...
	public class BCL_421_007_Verify_CSR_can_reason_for_hold_is_Pending_Bankruptcy_Filing
			extends TestBase {
		@Test
		public void BCL_421_007() throws Exception {
			test = report.createTest(
					"BCL.421.007 - Verify CSR can add a collection hold on the account with reason for hold is Pending Bankruptcy Filing");
			...
			cf.selectDropdown("Reason For Hold", " Pending Bankruptcy Filing ");
			cf.clickButtonContains("Continue ");
