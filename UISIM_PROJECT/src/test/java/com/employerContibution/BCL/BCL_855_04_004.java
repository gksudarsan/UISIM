...
public class BCL_855_04_004 extends TestBase {
	@Test
	public void BCL_855_04_004() throws Exception
	{
		
		 test = report.createTest("BCL.855.04.004 - Verify CSR can search ERN and put single NPRs for an SSN on hold or release with status is 'Generated' and reason is Order to Show Cause Filed'");
		 ...
		 sleep(1000);
			...
			sleep();
			BclPage.updateReferralStatusGeneratedValue.click();
			sleep();
			BclPage.updateReferralReason.click();
			sleep();
			BclPage.updateReferralReasonOrderShowValue.click();
			sleep();
