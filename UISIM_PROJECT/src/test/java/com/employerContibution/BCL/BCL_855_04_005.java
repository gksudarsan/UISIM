...
public class BCL_855_04_005 extends TestBase {
	@Test
	public void BCL_855_04_005() throws Exception
	{
		
		 test = report.createTest("Verify CSR can search ERN and put ALL NPRs for an SSN on hold or release with status is Voided and reason is Employer Appeal'");
		 ...
		 sleep(1000);
		 	 Map<String, String> databaseResults = commonFuntions.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE REGISTRATION_STATUS = 'C'  and EAN = '0463960'","EAN");
			...
			sleep();
			BclPage.updateReferralStatusVoidedValue.click();
			sleep();
			BclPage.updateReferralReason.click();
			sleep();
			BclPage.updateReferralReasonEmployerAppealValue.click();
			sleep();
