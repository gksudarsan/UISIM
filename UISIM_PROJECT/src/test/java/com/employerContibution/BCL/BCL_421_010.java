...
public class BCL_421_010 extends TestBase {

	@Test(priority = 1, description = "BCL.421.010 - Verify CSR can add a collection hold on the account with reason for hold is Referred to Attorney General", groups = {
			"Regression" })
	public void BCL_421_010() throws Exception {
		...
		test = report.createTest(
				"BCL.421.010 - Verify CSR can add a collection hold on the account with reason for hold is Referred to Attorney General");
		...
		commonFuntions.selectDropdown("Reason For Hold", " Referred to Attorney General ");
		sleep(1000);
