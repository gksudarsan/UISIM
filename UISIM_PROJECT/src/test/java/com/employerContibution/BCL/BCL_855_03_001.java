...
public class BCL_855_03_001 extends TestBase {
	...
	public void BCL_855_03_001() throws Exception {
		...
		test = report
				.createTest("BCL.855.03.001 - Verify CSR can search for the list of mailed NPR letters for an ERN");
		...
		commonFuntions.clickButtonContains("Search");
		sleep(2000);
		commonFuntions.screenShot("ErrorLabel2", "Pass",
				"The response to Employer Registration Number is an invalid Employer Registration Number");
		commonFuntions.errorLabelContains(
				" The response to Employer Registration Number is an invalid Employer Registration Number.",
		...
		Map<String, String> databaseResults = commonFuntions.database_SelectQuerySingleColumn(
				"SELECT  B.SSN AS ssn,\r\n" + "                            COALESCE (B.FIRST_NAME, ' ') ||\r\n"
						...
						+ "ON A.EMPLOYER_ACCOUNT_ID=B.EMPLOYER_ACCOUNT_ID",
