...
public class BCL_484_001_Verify_CSR_can_search_for_warrant_vacate_with_reason_for_vacate_is_Payment_Received
		extends TestBase {
	@Test
	public void BCL_484_001() throws Exception {

		test = report.createTest(
				"BCL.484.001 - Verify CSR can search for warrants in an active status based on the ERN and process warrant vacate with reason for vacate is 'Payment Received', task will create for manager review");
		...
		cf.screenShot("Required EAN Error label", "Pass", "Launched to COL-498");

		// Invalid
		cf.enterTextboxContains("Employer Registration Number (ERN)", "1111111");
		cf.clickButtonContains("Continue ");
		cf.errorContent("The response to Employer Registration Number is invalid.");
		cf.screenShot("Invalid EAN Error label", "Pass", "Launched to COL-498");

		// No-Records
		cf.enterTextboxContains("Employer Registration Number (ERN)", "9311967");
		cf.clickButtonContains("Continue ");
		cf.waitForLoadingIconToDisappear();
		cf.errorContent("No Records Found.");
		cf.screenShot("No Records Found", "Pass", "Launched to COL-498");
		...
		cf.selectDropdown("If yes, select the reason to Vacate a Warrant", " Payment Received ");
		...
		cf.database_UpdateQuery("UPDATE LROUIM.T_WFA_WORK_ITEM_DETAIL SET USER_ID = '"
		...
		//SUC-002
		cf.screenShot("Request to Vacate Warrant Approval Task Confirmation", "Pass", "Successfully launched to SUC-002");
		cf.Label("Request to Vacate the Warrant is Approved and a Vacate Warrant Follow-Up Task has been created successfully.");
