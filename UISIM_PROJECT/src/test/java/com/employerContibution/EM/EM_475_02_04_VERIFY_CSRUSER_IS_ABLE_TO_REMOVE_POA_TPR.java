package com.employerContibution.EM;
	...
	public class EM_475_02_04_VERIFY_CSRUSER_IS_ABLE_TO_REMOVE_POA_TPR extends TestBase{
		...
		public void Testing123() throws Exception {
			...
			test = report.createTest("EM_475_02_04_VERIFY_CSRUSER_IS_ABLE_TO_REMOVE_POA_TPR");
			...
			Map<String, String> databaseEanResult =
					commonFunction.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea  WHERE EAN IS NOT NULL AND EAN IN (SELECT EAN FROM T_EMPLOYER te WHERE employer_id IN (SELECT EMPLOYER_ID FROM T_THIRD_PARTY_CDS_VENDOR_ASSOCIATION ttpcva WHERE DESIGNATION_TYPE = 'UIBCM' ))", "EAN");
		   ...
		   commonFunction.selectDropdown("Designation Type", "Unemployment Insurance Benefit Claim Matters");
	       sleep(1000);
