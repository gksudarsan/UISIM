...
public class EM_443_02_007_VerifyEmployerAddPoaTpr extends TestBase{
	...
	public void EM_443_02_005() throws Exception
	{
		...
		test = 
				report.createTest("EM.443.02.007. Verify Employer is able Add POA/TPR association for designation type \"Payroll Agent Agreement\" and the system creates task for CSR reviews and approved.");
		...
		cf.selectDropdown("Designation Type", " Payroll Agent Agreement - Solely for the purpose of filing returns and payments ");
