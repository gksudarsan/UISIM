...
import com.ui.pages.LoginPage;
	...
	public class EM_443_02_003_Verify_Employer_able_Add_POA_Filing_Agent_Matters extends TestBase {

		String EAN = prop.getProperty("EAN");

		@Test(priority = 1, description = "EM.443.02.003.Verify Employer is able Add POA/TPR association for designation type \"Filing Agent Matters\"and the system creates task for CSR reviews and approved.", groups = {
				"Regression" })
		public void EM_443_02_003() throws Exception {
			test = report.createTest(
					"EM.443.02.003.Verify Employer is able Add POA/TPR association for designation type \"Filing Agent Matters\"and the system creates task for CSR reviews and approved.");
