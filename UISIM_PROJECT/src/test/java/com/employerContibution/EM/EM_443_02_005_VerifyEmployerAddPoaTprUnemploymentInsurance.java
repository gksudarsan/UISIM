...
public class EM_443_02_005_VerifyEmployerAddPoaTprUnemploymentInsurance extends TestBase{
	...
	public void EM_443_02_005() throws Exception
	{
		...
		test = 
				report.createTest("EM.443.02.005:Verify Employer is able Add POA/TPR association for designation type \"Unemployment Insurance Employer Services and Collection Matters\" and the system creates task for CSR reviews and Deny.");
		...
		cf.selectDropdown("Designation Type", " Unemployment Insurance Employer Services and Collection Matters ");
		...
		cf.safeJavaScriptClick(sreg537.UnemploymentInsuranceEmployerServicesAndCollectionMatters_RadioButton);
