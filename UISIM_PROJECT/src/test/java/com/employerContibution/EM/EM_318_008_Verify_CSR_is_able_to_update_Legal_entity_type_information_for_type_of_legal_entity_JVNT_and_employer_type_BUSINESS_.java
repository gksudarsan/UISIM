package com.employerContibution.EM;
		...
		public class EM_318_008_Verify_CSR_is_able_to_update_Legal_entity_type_information_for_type_of_legal_entity_JVNT_and_employer_type_BUSINESS_  extends TestBase{
		...
		/*commonFunction.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'JVNT' AND EAN LIKE '8%'"
						  , "EAN");*/
						 commonFunction.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'JVNT'"
								  , "EAN");
				...
				sleep(2000);
				commonFunction.selectDropdown("Type of Legal Entity", "Joint Venture - Internal User only");
