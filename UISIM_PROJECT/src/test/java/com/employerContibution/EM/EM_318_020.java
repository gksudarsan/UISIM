...
public class EM_318_020 extends TestBase
{


	
	@Test(priority=1, description = "EM.318.020 Verify CSR is able to update Legal entity type information for type of legal entity 'School'  and employer type 'Indian Tribe'",groups = {"Regression"})
	public void EM_318_020() throws Exception
	{
		 
		 test = report.createTest("EM.318.020 Verify CSR is able to update Legal entity type information for type of legal entity 'School'  and employer type 'Indian Tribe'.");
		 ...
		 Map<String, String> databaseEanResult = commonFuntions.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'HOUA' AND EAN IS NOT NULL","EAN");
		 ...
		 commonFuntions.selectDropdownUsingSearch("Type of Legal Entity","School"); 
