...
public class EM_314_02_005_Verify_Employer_abletochangemethodfinancingtocontributoryand_CSRreviewsandDeny
		extends TestBase {

	String EAN = prop.getProperty("EAN");

	@Test(priority = 1, description = "EM.314.02.005. Verify Employer is able to request for change method of financing  to contributory and the system create task for CSR reviews and Deny", groups = {
			"Regression" })
	public void EM_314_02_005() throws Exception {
		test = report.createTest(
				"EM.314.02.005. Verify Employer is able to request for change method of financing  to contributory and the system create task for CSR reviews and Deny");
