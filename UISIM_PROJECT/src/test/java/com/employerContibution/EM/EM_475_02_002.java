...
public class EM_475_02_002 extends TestBase
{


	
	@Test(priority=1, description = "EM.475.02.002 - Verify Employer is able to remove POA/TPR association for designation type  \"Limited Unemployment Insurance Matters\" .",groups = {"Regression"})
	public void EM_475_02_002() throws Exception
	{
		 
		 test = report.createTest("EM.475.02.002 - Verify Employer is able to remove POA/TPR association for designation type  \"Limited Unemployment Insurance Matters\" .");
