...
public class EM_318_001_Verify_CSR_is_able_to_update_Legal_entity_type_information_for_type_of_legal_entity_CorporationAll_types_and_employer_type_Business extends TestBase{


	@Test(priority = 1, description = "Test sample", groups = { "Regression" })
	public void Testing123() throws Exception {
		
		test = report.createTest("EM.381.001- Verify CSR is able to update Legal entity type information for type of legal entity 'Corporation(All types)' and employer type 'Business'");
...
//commonFunction.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'LLCA' AND EAN LIKE '8%'", "EAN");
				 commonFunction.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'LLCA'"
						  , "EAN"); 
