...
public class EM_318_012 extends TestBase
{


	
	@Test(priority=1, description = "EM.318.012 Verify CSR is able to update Legal entity type information for type of legal entity 'Unincorporated Association' and employer type 'Non-Profit'",groups = {"Regression"})
	public void EM_318_012() throws Exception
	{
		 
		 test = report.createTest("EM.318.012 Verify CSR is able to update Legal entity type information for type of legal entity 'Unincorporated Association' and employer type 'Non-Profit'.");
		 commonStepDefinitions commonFuntions = new commonStepDefinitions();
		// Map<String, String> databaseEanResult = commonFuntions.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'CORA' AND EAN LIKE '8%'","EAN");
		 Map<String, String> databaseEanResult = commonFuntions.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'CORA' AND EAN IS NOT NULL","EAN");
		 ...
		 commonFuntions.selectDropdownUsingSearch("Type of Legal Entity"," Unincorporated Association "); 
