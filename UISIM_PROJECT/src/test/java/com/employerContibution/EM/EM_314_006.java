...
public class EM_314_006 extends TestBase {

	@Test(priority = COMMON_CONSTANT.PRIORITY_1, description = "EM.314.006 - Verify CSR is able to enter request for change method of financing to Contributory and new ERN for employer type Governmental.", groups = {COMMON_CONSTANT.REGRESSION} )
	public void EM_314_006() throws Exception {
		
		test = report.createTest("EM.314.006 - Verify CSR is able to enter request for change method of financing to Contributory and new ERN for employer type Governmental.");
		...
		Map<String, String> databaseEanResult = commonFunction.database_SelectQuerySingleColumn(
				"SELECT * FROM T_EMPLOYER_ACCOUNT WHERE EAN = '2200302'",
				"EAN");
		...
		commonFunction.enterTextbox("New ERN", "7775883");
