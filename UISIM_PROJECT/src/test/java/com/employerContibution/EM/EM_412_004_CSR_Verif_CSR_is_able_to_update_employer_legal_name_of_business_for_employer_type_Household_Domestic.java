...
public class EM_412_004_CSR_Verif_CSR_is_able_to_update_employer_legal_name_of_business_for_employer_type_Household_Domestic extends TestBase {

		@Test(priority = 1, description = "Verify CSR is able to update employer legal name of business for employer type 'Household_Domestic'.", groups = { "Regression" })
		public void EM_412_004()throws Exception {
			test=report.createTest("Verify CSR is able to update employer legal name of business for employer type 'Household_Domestic'");
			...
			employerRegisterPage.legalEntityNameId.sendKeys("Homemaker");
	        sleep(4000);
			...
			CommFun.enterTextboxContains(" Business Phone Number ", "8987889995");
		
			CommFun.selectDropdown("Employer Type", " Household/Domestic Employer ");
			CommFun.selectDropdownEquals("Source", " IA602 ");
		    CommFun.selectDropdown("Source Type", " L&D SUTA ");
		    sleep(2000);
		    CommFun.screenShot("Modify Employer Account Details", "Pass", "ENtered details on SREG 030");
