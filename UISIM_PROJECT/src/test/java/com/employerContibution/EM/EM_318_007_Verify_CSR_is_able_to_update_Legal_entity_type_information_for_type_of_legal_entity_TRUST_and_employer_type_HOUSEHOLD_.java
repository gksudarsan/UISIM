package com.employerContibution.EM;
		...
		public class EM_318_007_Verify_CSR_is_able_to_update_Legal_entity_type_information_for_type_of_legal_entity_TRUST_and_employer_type_HOUSEHOLD_  extends TestBase{
		...
		/*commonFunction.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'TRUS' AND EAN LIKE '8%'"
						  , "EAN");*/
						 
						 commonFunction.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'TRUS'", "EAN");		 
