...
public class EM_318_13 extends TestBase
 {


	
	@Test(priority=1, description = "EM.318.013 Verify CSR is able to update Legal entity type information for type of legal entity 'City' and employer type 'Governmental' ",groups = {"Regression"})
	public void EM_318_013() throws Exception
	{
		 
		 test = report.createTest("EM.318.013 Verify CSR is able to update Legal entity type information for type of legal entity 'City' and employer type 'Governmental' .");
		 commonStepDefinitions commonFuntions = new commonStepDefinitions();
		// Map<String, String> databaseEanResult = commonFuntions.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'TOWN' AND EAN LIKE '8%'","EAN");
		 ...
		 commonFuntions.selectDropdownUsingSearch("Type of Legal Entity"," City "); 
