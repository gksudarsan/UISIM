...
public class EM_411_006_CSR_Update_Employer_Account_CancelExempt extends TestBase {
	...
	public void TC_EM_411_006() throws Exception {
		...
		// --- SREG-434 ---
		sleep(2000);
		commonFunction.screenShot("EM411006", "Pass", "Successfully launched to Maintain Account Status - Enter ERN(SREG-434) page");
		sleep();
		commonFunction.enterTextbox("Employer Registration Number", eanValue); //54-44434, 52-05552
		commonFunction.clickButton("Continue ");
		
		// --- SREG-435 ---
		sleep(2000);
		commonFunction.screenShot("EM411006", "Pass", "Successfully launched to Update Account Status(SREG-434) page");
		commonFunction.selectDropdown("Status of Employer Account", " Cancelled Exempt ");
		
		/*
		 * empManage.suspensionDateQtrDropdown_SREG435.click(); sleep();
		 * commonFunction.selectFromDropdown(" 4 ");
		 * empManage.suspensionDateYearDropdown_SREG435.click(); sleep();
		 * commonFunction.selectFromDropdown(" 2023 ");
		 * 
		 * empManage.sourceId_SREG435.click(); sleep(); empManage.IA602_SREG435.click();
		 * empManage.sourceTypeId_SREG435.click(); sleep();
		 * empManage.InformationFromAudit_SREG435.click();
		 */
		commonFunction.screenShot("EM411006", "Pass", "Edited Details in SREG-435 page");
		commonFunction.clickButtonContains("Submit ");

		// --- SUC - 002 ---
		sleep(2000);
		commonFunction.screenShot("EM411006", "Pass", "Successfully launched to SUC - 002 page");
		
		sleep(2000);
		commonFunction.screenShot("SuccessPage", "Pass", "TC EM_411_006 passed succesfully");
