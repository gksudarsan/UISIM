...
public class EM_328_03_002_Verify_TPR_able_updatePOA_TPR_NoticeOfPotentialChargesLO400 extends TestBase {

	String EAN = prop.getProperty("EAN");

	@Test(priority = 1, description = "EM.328.03.002 - Verify TPR is able to  update POA/TPR details with additional address Form Type 'Notice of Potential Charges (LO400)'", groups = {
			"Regression" })
	public void EM_328_03_002() throws Exception {
		test = report.createTest(
				"EM.328.03.002 - Verify TPR is able to  update POA/TPR details with additional address Form Type 'Notice of Potential Charges (LO400)'");
		...
		cf.selectRadioQuestions("Form Type", "Notice of Potential Charges (LO400)");
