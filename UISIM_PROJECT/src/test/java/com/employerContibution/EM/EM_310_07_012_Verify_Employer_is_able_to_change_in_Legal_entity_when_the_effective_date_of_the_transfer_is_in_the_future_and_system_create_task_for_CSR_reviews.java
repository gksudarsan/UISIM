...
public class EM_310_07_012_Verify_Employer_is_able_to_change_in_Legal_entity_when_the_effective_date_of_the_transfer_is_in_the_future_and_system_create_task_for_CSR_reviews
		extends TestBase {
	...
	public void Tc_EM_310_07_011() throws Exception {
		...
		test = report.createTest(
				"EM_310_07_012_Verify_Employer_is_able_to_change_in_Legal_entity_when_the_effective_date_of_the_transfer_is_in_the_future_and_system_create_task_for_CSR_reviews");
		...
		Map<String, String> databaseResults = PEOPage.database_SelectQuery(
				"SELECT ACCOUNT_STATUS status, * FROM T_EMPLOYER_ACCOUNT tea WHERE ACCOUNT_STATUS ='CANE'");
		...
		Thread.sleep(1000);
		commonFuntions.enterFutureDate("Date of Legal Entity change", 7);
		Thread.sleep(1000);
		...
		test.info("Step: 11 --");
		//VerifypredecessorData  ork item is dispalyed
		...
		Thread.sleep(2000);
		commonFuntions.screenShot("", "Pass", "EEWI-014 screen is visible");

		test.info("Step: 12 --");
		try {
			sreg043.EEWI014CommentFeild.sendKeys("Review em comment");
		} catch(Exception exception) {
			sreg043.EEWI012CommentFeild.sendKeys("Review em comment");
		}
