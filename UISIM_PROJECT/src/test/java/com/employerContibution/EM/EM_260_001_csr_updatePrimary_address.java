...
public class EM_260_001_csr_updatePrimary_address {
	...
	public class EM_260_001 extends TestBase
	{
		...
		public void Testing123() throws Exception
		{
			...
			//---SREG-070---
			cf.screenShot("EE01008", "Pass", "Sucessfully launched to SREG-070 page");
			...
			//---SREG-486---
			cf.screenShot("EE01008", "Pass", "Sucessfully launched to SREG-486 page");
			cf.clickOnLink("Edit");
			sleep(20000);
			...
			//---EM-051---
			cf.screenShot("EE01008", "Pass", "Sucessfully launched to EM-051 page");
			cf.enterTextboxContains("Employer Registration Number", "");
			cf.clickButton("Continue ");
			sleep();
			cf.screenShot("EE01008", "Pass", "Message 'Required' on SREG-070");
			...
			cf.clickButton("Continue ");
			sleep();
			cf.screenShot("EE01008", "Pass", "Message 'Does not exist in the system please enter valid ERN' on SREG-070");
			cf.enterTextboxContains("Employer Registration Number", EAN);
			cf.screenShot("EE01008", "Pass", "ERN Entered on SREG-070 page");
			cf.clickButton("Continue ");
			sleep(20000);
			...
			//---SREG-057---
			cf.screenShot("EE01008", "Pass", "Sucessfully launched to SREG-057 page");
