package com.employerContibution.EM;
		...
		public class EM_318_003_Verify_CSR_is_able_to_update_Legal_entity_type extends TestBase{
		...
		//commonFunction.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'PART' AND EAN LIKE '8%'", "EAN");
				...
				sleep(2000);
				commonFunction.selectDropdown("Type of Legal Entity", "Limited Partnership");
				commonFunction.selectDropdown("Employer Type", "Business Employer");
				commonFunction.selectDropdown("Source", "IA602");
				commonFunction.selectDropdown("Source Type", "Other");
