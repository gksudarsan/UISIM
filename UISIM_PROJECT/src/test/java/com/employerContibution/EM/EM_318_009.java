...
public class EM_318_009 extends TestBase
{


	
	@Test(priority=1, description = "EM.318.009 Verify CSR is able to update Legal entity type information for type of legal entity 'Guardianship - Internal User only' and employer type 'Business'",groups = {"Regression"})
	public void EM_318_009() throws Exception
	{
		 
		 test = report.createTest("EM.318.009 Verify CSR is able to update Legal entity type information for type of legal entity 'Guardianship - Internal User only' and employer type 'Business'");
		 
		 commonStepDefinitions commonFuntions = new commonStepDefinitions();

		 Map<String, String> databaseEanResult = commonFuntions.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'ESTA' AND EAN IS NOT NULL","EAN");
				 //"SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'ESTA' AND EAN LIKE '8%'","EAN");
		 ...
		 sleep();	 
		 commonFuntions.enterTextboxContains("Employer Registration Number", eanValue); //Employer Registration Number
         ...
         commonFuntions.selectDropdownUsingSearch("Type of Legal Entity"," Guardianship  Internal User Only "); 
		 commonFuntions.selectRadio(" Send LDD097 SDC No Report Due letter");
		 commonFuntions.selectDropdown("Employer Type", " Business Employer ");
