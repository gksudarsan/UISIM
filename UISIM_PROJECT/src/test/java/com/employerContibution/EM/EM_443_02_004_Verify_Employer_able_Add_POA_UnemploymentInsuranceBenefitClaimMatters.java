...
public class EM_443_02_004_Verify_Employer_able_Add_POA_UnemploymentInsuranceBenefitClaimMatters extends TestBase {

	String EAN = prop.getProperty("EAN");

	@Test(priority = 1, description = "EM.443.02.004 Verify Employer is able Add POA/TPR association for designation type \"Unemployment Insurance Benefit Claim Matters\" and the system creates task for CSR reviews and approved.", groups = {
			"Regression" })
	public void EM_443_02_004() throws Exception {
		test = report.createTest(
				"EM.443.02.004 Verify Employer is able Add POA/TPR association for designation type \"Unemployment Insurance Benefit Claim Matters\" and the system creates task for CSR reviews and approved.");
		...
		cf.selectDropdown("Designation Type", "Unemployment Insurance Benefit Claim Matters");
		...
		sleep();
		cf.screenShot("ApprovePOA/ThirdPartyAssociationtoEmployer", "Pass", "Launched to SREG-499");
		cf.clickButtonContains("Submit");
		sleep(2000);
