...
public class EM_443_02_001_Verify_Employer_POA_All_Unemployment_insurance_Matters extends TestBase {

	String EAN = prop.getProperty("EAN");

	@Test(priority = 1, description = "EM.443.02.001 Verify Employer is able Add POA/TPR association for designation type All Unemployment insurance Matters and the system creates task for CSR reviews and approved.", groups = {
			"Regression" })
	public void EM_443_02_001() throws Exception {
		test = report.createTest(
				"EM.443.02.001 Verify Employer is able Add POA/TPR association for designation type All Unemployment insurance Matters and the system creates task for CSR reviews and approved.");
		...
		cf.screenShot("ApprovePOA/ThirdPartyAssociationtoEmployer", "Pass",
				"Approve POA/Third Party Association to Employer:SREG-499");
		cf.clickButtonContains("Submit");
		sleep(2000);
