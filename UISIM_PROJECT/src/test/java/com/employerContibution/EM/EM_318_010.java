...
public class EM_318_010 extends TestBase
{


	
	@Test(priority=1, description = "EM.318.010 Verify CSR is able to update Legal entity type information for type of legal entity 'Sole Proprietorship (Individual)' and employer type 'Household/Domestic'",groups = {"Regression"})
	public void EM_318_010() throws Exception
	{
		 
		 test = report.createTest("EM.318.010 Verify CSR is able to update Legal entity type information for type of legal entity 'Sole Proprietorship (Individual)' and employer type 'Household/Domestic'");
		 commonStepDefinitions commonFuntions = new commonStepDefinitions();
		 Map<String, String> databaseEanResult = commonFuntions.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'PART' AND EAN IS NOT NULL","EAN");
		 //Map<String, String> databaseEanResult = commonFuntions.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'PART' AND EAN LIKE '8%'","EAN");
		 ...
		 commonFuntions.screenShot("Entered Employer Registration Number","Pass","Entered Employer Registration Number");sleep();
		 ...
		 commonFuntions.selectDropdownUsingSearch("Type of Legal Entity"," Sole Proprietorship (Individual) "); 
