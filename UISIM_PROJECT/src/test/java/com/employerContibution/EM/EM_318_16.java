...
public class EM_318_16 extends TestBase
{


	
	@Test(priority=1, description = "EM.318.016 Verify CSR is able to update Legal entity type information for type of legal entity 'School District' and employer type 'Governmental' ",groups = {"Regression"})
	public void EM_318_016() throws Exception
	{
		 
		 test = report.createTest("EM.318.016 Verify CSR is able to update Legal entity type information for type of legal entity 'School District' and employer type 'Governmental' .");
		 commonStepDefinitions commonFuntions = new commonStepDefinitions();
		// Map<String, String> databaseEanResult = commonFuntions.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'CITY' AND EAN LIKE '8%'","EAN");
		 Map<String, String> databaseEanResult = commonFuntions.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'CITY' AND EAN IS NOT NULL","EAN");
		 ...
		 commonFuntions.selectDropdownUsingSearch("Type of Legal Entity"," School District ");
