...
public class EM_443_006_CSR_Verify_CSR_is_able_to_search_POA_TPR_detail_and_Add_the_association_for_POA_TPR_with_designation_type_Unemployment_Insurance_Employer_Services_and_Collection_Matters extends TestBase{

	@Test(priority=1, description = "EM.443.006.Verify CSR is able to search POA/TPR detail and Add the association for POA/TPR with designation type Unemployment Insurance Administrative Proceedings and Court Appeals Matters",groups = {"Regression"})
	public void EM_443_006() throws Exception
	{
		commonStepDefinitions commonFuntions= new commonStepDefinitions();
		PEOPage PEOPage = PageFactory.initElements(driver, PEOPage.class);
		HomePage home = new HomePage(driver);
		test = report.createTest("EM.443.006.Verify CSR is able to search POA/TPR detail and Add the association for POA/TPR with designation type Unemployment Insurance Administrative Proceedings and Court Appeals Matters");
		//-------Login
		...
		sleep(2000);
		commonFuntions.selectRadioInTable("Unemployment Insurance Administrative Proceedings and Court Appeals Matters", 1, 1, "Add or Remove Third Party Association to Employer");
		//commonFuntions.selectRadio("Select");
		Thread.sleep(2000);
