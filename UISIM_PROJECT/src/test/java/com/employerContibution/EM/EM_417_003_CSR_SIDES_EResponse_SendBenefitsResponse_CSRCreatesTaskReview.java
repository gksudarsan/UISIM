...
public class EM_417_003_CSR_SIDES_EResponse_SendBenefitsResponse_CSRCreatesTaskReview extends TestBase {

	@Test(priority = COMMON_CONSTANT.PRIORITY_1, description = "Verify Employer is able to adding SIDES E-Response to send benefits notification for an employer account and the system create task for CSR reviews and Approve", groups = {COMMON_CONSTANT.REGRESSION})
	public void TC_EM_417_003() throws Exception {
		
		test = report.createTest("Verify Employer is able to adding SIDES E-Response to send benefits notification for an employer account and the system create task for CSR reviews and Approve");
		...
		commonFunction.enterTextboxContains("Employer Registration Number", eanValue); //eanvalue
		...
		sleep(1000);
		/*
		 * empManage.sourceId_SREG435.click(); sleep(); empManage.nys100_paper.click();
		 * empManage.sourceTypeId_SREG435.click(); sleep(); empManage.nys100.click();
		 */
