package com.employerContibution.EM;
		...
		public class EM_318_005_Verify_CSR_is_able_to_update_Legal_entity_type_information_for_type_of_legal_entity_Other_and_employer_type_Governmental_ extends TestBase{
			...
			public void Testing123() throws Exception {
				...
				test = report.createTest("EM_318_005_Verify_CSR_is_able_to_update_Legal_entity_type_information_for_type_of_legal_entity_Other_and_employer_type_Governmental");
		...
		/*commonFunction.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'CITY' AND EAN LIKE '8%'"
						  , "EAN");*/
						 
						 commonFunction.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'OTHR'"
								  , "EAN");
				...
				commonFunction.selectDropdown("Employer Type", "Governmental Employer");
