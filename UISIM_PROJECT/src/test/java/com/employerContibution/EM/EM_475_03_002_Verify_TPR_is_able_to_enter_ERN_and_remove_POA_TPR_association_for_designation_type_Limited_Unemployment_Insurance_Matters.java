...
public class EM_475_03_002_Verify_TPR_is_able_to_enter_ERN_and_remove_POA_TPR_association_for_designation_type_Limited_Unemployment_Insurance_Matters extends TestBase{
	...
	public void Testing123() throws Exception {
		...
		test = report.createTest("EM_475_03_002_Verify_TPR_is_able_to_enter_ERN_and_remove_POA_TPR_association_for_designation_type_Limited_Unemployment_Insurance_Matters ");
		...
		commonFunction.enterTextboxContains("Employer Registration Number", "0504110");
        ...
        commonFunction.selectDropdown("Designation Type", "Limited Unemployment Insurance Matters");
        sleep(1000);
