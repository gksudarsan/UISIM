...
public class EM_314_008_CSR_EnterRequest_ChangeMethod_FinancingToContributory_No extends TestBase {
	...
	public void TC_EM_314_008() throws Exception {
		...
		test = report.createTest("Verify CSR is able to enter request for change method of financing  to Contributory with select option No.");
		...
		// --- ETR-228 ---
		sleep(2000);
		commonFunction.screenShot("EM314008", "Pass", "Successful launch to Change in Method of Financing(ETR-228) page");
		commonFunction.enterTextboxContains("Employer Registration Number", "1371365");
		commonFunction.clickButtonContains("Continue ");
		
		
		sleep(2000);
		commonFunction.screenShot("EE314008", "Fail", "System Failure");
