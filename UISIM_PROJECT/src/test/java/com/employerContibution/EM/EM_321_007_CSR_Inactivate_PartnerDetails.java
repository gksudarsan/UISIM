...
public class EM_321_007_CSR_Inactivate_PartnerDetails extends TestBase{
	...
	public void TC_EM_321_005() throws Exception {
		...
		commonFunction.enterTextbox("Employer Registration Number", eanValue); //0501573
		...
		commonFunction.enterTextboxContains("Term End Date", "05/24/2023");
		...
		commonFunction.screenShot("EM321007", "Pass", "USPS Business address selection on SREG-703");
		try {
