...
public class EM_443_003_CSR_Verify_CSR_is_able_to_search_POA_TPR_detail_and_Add_the_association_for_POA_TPR_with_designation_type_Filing_Agent_Matters extends TestBase{

	@Test(priority=1, description = "EM.443.003.Verify CSR is able to search POA/TPR detail and Add the association for POA/TPR with designation type \"Filing Agent Matters\"",groups = {"Regression"})
	public void EM_443_003() throws Exception
	{
		commonStepDefinitions commonFuntions= new commonStepDefinitions();
		PEOPage PEOPage = PageFactory.initElements(driver, PEOPage.class);
		HomePage home = new HomePage(driver);
		test = report.createTest("EM.443.003.Verify CSR is able to search POA/TPR detail and Add the association for POA/TPR with designation type \"Filing Agent Matters\"");
		//-------Login
		...
		sleep(2000);
		commonFuntions.selectRadioInTable("Filing Agent Matters", 1, 1, "Add or Remove Third Party Association to Employer");
		//commonFuntions.selectRadio("Select");
		Thread.sleep(2000);
