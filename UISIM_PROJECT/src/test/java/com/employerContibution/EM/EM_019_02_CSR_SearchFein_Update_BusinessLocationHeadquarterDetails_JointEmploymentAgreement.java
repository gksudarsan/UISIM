...
public class EM_019_02_CSR_SearchFein_Update_BusinessLocationHeadquarterDetails_JointEmploymentAgreement extends TestBase{

	@Test(priority = COMMON_CONSTANT.PRIORITY_1, description = "Verify CSR is able to search FEIN and update related Business Location/ Headquarters Details’ for an joint employment agreement.", groups = {COMMON_CONSTANT.REGRESSION})
	public void TC_EM_019_02() throws Exception {
		
		test = report.createTest("EM.019.02: Verify CSR is able to search FEIN and update related Business Location/ Headquarters Details’ for an joint employment agreement.");
		...
		// --- SREG-520 ---
		sleep(2000);
		commonFunction.screenShot("EM01902", "Pass", "Successful launch to Joint Employment/Management Agreement Creation(SREG-520) screen");
		...
		// --- SREG-110 ---
		sleep(2000);
		commonFunction.screenShot("EM01902", "Pass", "Successful launch to Joint Employment/Management Agreement(SREG-110) screen");
		...
		commonFunction.screenShot("EM01902", "Pass", "Navigated in SREG 110 screen.");
		commonFunction.clickButtonContains("Continue ");
		
		// --- SREG-007 ---
		sleep(2000);
		commonFunction.screenShot("EM01902", "Pass", "Successful launch to Related Business Details(SREG-007) screen");
		...
		sleep();
		commonFunction.screenShot("EM01902", "Pass", "Details enetered on SREG-007 screen");
		commonFunction.clickButtonContains("Continue ");
		
		// --- SREG-114 ---
		sleep(2000);
		commonFunction.screenShot("EM01902", "Pass", "Successful launch to Verify Joint Employment or Management Agreement(SREG-114) screen");
		commonFunction.clickButtonContains("Continue ");
		
		// --- SREG-524 ---
		sleep(2000);
		commonFunction.screenShot("EM01902", "Pass", "Successful launch to Verify Joint Employment or Management Agreement(SREG-524) screen");
		commonFunction.clickButtonContains("Continue ");
