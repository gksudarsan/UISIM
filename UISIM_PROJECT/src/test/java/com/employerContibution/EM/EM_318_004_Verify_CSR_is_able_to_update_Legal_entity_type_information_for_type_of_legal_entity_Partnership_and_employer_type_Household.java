package com.employerContibution.EM;
	...
	public class EM_318_004_Verify_CSR_is_able_to_update_Legal_entity_type_information_for_type_of_legal_entity_Partnership_and_employer_type_Household extends TestBase{


		@Test(priority = 1, description = "Test sample", groups = { "Regression" })
		public void Testing123() throws Exception {
			
			test = report.createTest("Verify CSR is able to update Legal entity type information for type of legal entity 'Limited Partnership' and employer type 'Business'EM_318_004_Verify_CSR_is_able_to_update_Legal_entity_type_information_for_type_of_legal_entity_Partnership_and_employer_type_Household");
			...
			SUC_002 suc002 = new SUC_002(driver);
			 Map<String, String> databaseEanResult =
				/*
				 * commonFunction.
				 * database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'SPRI' AND EAN LIKE '8%'"
				 * , "EAN");
				 */		 
			 commonFunction.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'PART'"
					  , "EAN");
			...
			commonFunction.selectDropdown("Source Type", "Cash Wages");
