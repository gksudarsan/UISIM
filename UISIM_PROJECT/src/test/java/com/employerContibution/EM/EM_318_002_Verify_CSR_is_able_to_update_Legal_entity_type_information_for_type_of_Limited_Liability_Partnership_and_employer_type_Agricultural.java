...
import java.util.Map;
	...
	public class EM_318_002_Verify_CSR_is_able_to_update_Legal_entity_type_information_for_type_of_Limited_Liability_Partnership_and_employer_type_Agricultural extends TestBase{


		@Test(priority = 1, description = "Test sample", groups = { "Regression" })
		public void Testing123() throws Exception {
			
			test = report.createTest("EM.381.002-Verify CSR is able to update Legal entity type information for type of legal entity 'Limited Liability Partnership' and employer type 'Agricultural'");
	...
	//commonFunction.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'PART' AND EAN LIKE '8%'" , "EAN");
					 commonFunction.database_SelectQuerySingleColumn("SELECT * FROM T_EMPLOYER_ACCOUNT tea WHERE ORGANIZATION_TYPE = 'PART'" , "EAN");
			...
			sleep(2000);
			commonFunction.selectDropdown("Type of Legal Entity", "LLC Partnership");
			commonFunction.selectDropdown("Employer Type", " Agricultural Employer ");
