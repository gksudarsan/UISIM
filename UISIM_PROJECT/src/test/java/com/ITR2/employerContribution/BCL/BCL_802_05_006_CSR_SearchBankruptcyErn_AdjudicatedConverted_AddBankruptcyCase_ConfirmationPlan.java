...
public class BCL_802_05_006_CSR_SearchBankruptcyErn_AdjudicatedConverted_AddBankruptcyCase_ConfirmationPlan extends TestBase{
	...
	public void TC_BCL_802_05_006() throws Exception {
		
		test = report.createTest("BCL.802.05.006 : Verify CSR can Search ERN with select bankruptcy case status 'Adjudicated/Converted' and add Bankruptcy Case Activity for activity type incoming and activity name 'Confirmation Plan'");
		...
		commonFunction.selectDropdown("2. Bankruptcy Status", " Adjudicated/Converted ");
		sleep(2000);
		commonFunction.screenShot("BCL80205006", "Pass", "ERN entered in COL-474 screen");
		commonFunction.clickButtonContains(" Search ");
		
		sleep(4000);
		commonFunction.screenShot("BCL80205006", "Pass", "List of Bankruptcy cases on ERN search");
		
		commonFunction.selectRadioInTable("05-26421", 1, 1, "");
		sleep(2000);
		commonFunction.screenShot("BCL80205006", "Pass", "Selected radio basis of ERN");
		
		commonFunction.clickButtonContains("Continue ");
		
		// --- COL-475 ---
		commonFunction.waitForLoadingIconToDisappear();
		commonFunction.screenShot("BCL80205006", "Pass", "Successfully launched to View Bankruptcy Case Deatils/History(COL-475) screen");
		commonFunction.clickButtonContains("Add New Activity ");
		
		// --- COL-402 ---
		commonFunction.waitForLoadingIconToDisappear();
		commonFunction.screenShot("BCL80205006", "Pass", "Successfully launched to Add/Edit Activity - Bankruptcy Case Activity(COL-402) screen");
		...
		commonFunction.selectDropdown("3. Activity Name", " Petition Mailed ");
		...
		sleep(2000);
		commonFunction.screenShot("BCL80205006", "Pass", "Data entered in COL-402 screen");
		commonFunction.clickButtonContains("Continue ");
		
		// --- COL-513 ---
		commonFunction.waitForLoadingIconToDisappear();
		commonFunction.screenShot("BCL80205006", "Pass", "Successfully launched to Add/Edit - Activity Verification(COL-513) screen");
		commonFunction.clickButtonContains("Submit ");
		
		// --- SUC-002 ---
		commonFunction.waitForLoadingIconToDisappear();
		commonFunction.screenShot("BCL80205006", "Pass", "Successfully launched to SUC-002 screen");
		commonFunction.clickButtonContains("Home ");
		
		commonFunction.waitForLoadingIconToDisappear();
		sleep(3000);
		commonFunction.screenShot("BCL80205006", "Pass", "Successfully passed TC BCL.802.05.006");
